...
# SPECIFICATION: This code conducts a hyperparameter search for a neural network on the Fashion MNIST dataset using TensorFlow and Keras. 
#    It iterates over different combinations of hidden layers, neurons, and learning rates, trains models, and identifies the configuration with 
#    the highest accuracy on the test set, visualizing the best model's architecture and learning curves.
# FOR: CS 4210- Assignment #4
# TIME SPENT: A couple of hours over 2 days.
#-----------------------------------------------------------*/
